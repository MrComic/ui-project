import {
  ...
  CoreColors,
  CoreGradientColors,
  CoreGradientDuoToneColors,
  CoreSizes,
} from '../../../services/theme/Core.theme';

import { twMerge } from 'tailwind-merge';
import { mergeTheme } from '../../../services/util/merge-theme';
...
export interface ButtonProperties {
  ...
  pill: keyof CoreBoolean;
  outline: keyof ButtonFill;
  disabled: keyof CoreBoolean;
...
export interface ButtonRootTheme {
  ...
  gradientMonochrome?: Record<keyof CoreGradientColors, string>;
  gradientDuoTone?: Record<
    keyof ButtonDuoToneColors,
    Record<keyof ButtonFill, string>
  >;
  size: Record<keyof ButtonSizes, string>;
  pill: Record<keyof CoreBoolean, string>;
  disabled: Record<keyof CoreBoolean, string>;
}
...
export interface ButtonSizes
  extends Pick<CoreSizes, 'xs' | 'sm' | 'md' | 'lg' | 'xl'> {
  [key: string]: string;
}
