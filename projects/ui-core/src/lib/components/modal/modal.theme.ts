...
export interface ModalSizes extends Pick<CoreSizes, 'sm' | 'md' | 'lg' | 'xl'> {
  [key: string]: string;
}
...
export interface ModalClass extends CoreClass {
